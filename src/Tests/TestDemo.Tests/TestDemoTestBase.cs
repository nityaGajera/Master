...
namespace TestDemo.Tests
{
    public abstract class TestDemoTestBase : AbpIntegratedTestBase<TestDemoTestModule>
    {
        ...
        protected T UsingDbContext<T>(Func<TestDemoDbContext, T> func)
        {
            return UsingDbContext(AbpSession.TenantId, func);
        }

        protected Task<T> UsingDbContextAsync<T>(Func<TestDemoDbContext, Task<T>> func)
        {
        ...
        protected T UsingDbContext<T>(int? tenantId, Func<TestDemoDbContext, T> func)
        {
            T result;
        ...
        protected async Task<T> UsingDbContextAsync<T>(int? tenantId, Func<TestDemoDbContext, Task<T>> func)
        {
            T result;
