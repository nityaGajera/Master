    ...
    angular.module('app').controller(controllerId, [
        ...
        function ($rootScope, $state, appSession) {
            ...
            vm.menuItems = [
                ...
                createMenuItem(App.localize("Products"), "", "menu", "", [
                    createMenuItem("Product Category", "Pages.ProductCategory", "info", "product"),
                ]),
                createMenuItem(App.localize("Resource"), "", "menu", "", [
                    createMenuItem("Resource Category", "", "info", "resource"),
                    createMenuItem("Resource Document", "", "info", "resources"),
                ]),
                createMenuItem(App.localize("Sensor"), "Pages.Sensor", "info", "sensor"),
                createMenuItem(App.localize("Application"), "", "info", "application"),
